# from: https://github.com/uvavision/Balanced-Datasets-Are-Not-Enough/blob/master/object_multilabel/adv/ae_adv_model.py
...
class ObjectMultiLabelAdv(nn.Module):
    ...
    def forward(self, image):
        ...
        return preds# , adv_preds, autoencoded_image don't need these for our use
