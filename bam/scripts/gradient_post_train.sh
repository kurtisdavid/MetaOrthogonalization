...
modules=( "layer1.0" "layer1.2" "layer2.0" "layer2.2" )
...
do
    ...
    do
        ...
        python3 post_train.py --module $module --seed 0 -n2v --specific bowling_alley \
            --ratio $ratio --n2v_lr $n2v_lr --n2v_epochs $n2v_epochs --device $device \
